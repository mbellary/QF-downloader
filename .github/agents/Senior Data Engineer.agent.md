...
handoffs:
  - label: Start Code Review
    agent: Lead Senior Data Engineer
    prompt: The Senior Data engineer has implemented and tested the feature. Please proceed with verifying the implementation and creating the code review according to the design and execution plan.
    send: true
---
