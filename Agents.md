# AGENTS.md — Agent Guide for math-lib
...
**Project name:** math-lib  
**Purpose:** A small Python library that provides arithmetic functions via library import or CLI entry point (`worker`).  
**Language:** Python ≥ 3.11  
**Package layout:** standard `src/` layout  
**Entry point CLI:** `worker = math_lib.math:add_numbers` (defined in `pyproject.toml`)
...
* See `src/math_lib/AGENTS_LINTING.md` for details.
---
...
## 🎯 Coding Guidelines
* See `src/math_lib/AGENTS_CODING_GUIDELINES.md` for details.
---
